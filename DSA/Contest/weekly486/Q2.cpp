...
public:
    vector<int> rotateElements(vector<int>& nums, int k) {
        // if we can get the non negative values and their index in 2 arrays then we can just do rotation in the new array and then fill the original array with this 
        vector<int>pos;
        // vector<int>ids;
